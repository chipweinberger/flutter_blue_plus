...
class BluetoothDevice {
  ...
  Future<void> connect({
    ...
    try {
      ...
      // invoke
      bool changed = FlutterBluePlus._connectionStates[remoteId]?.connectionState != BmConnectionStateEnum.connected;
      await FlutterBluePlus._invokeMethod(() => FlutterBluePlusPlatform.instance.connect(request));
      ...
      if (changed && !autoConnect) {
        BmConnectionStateResponse response = await futureState
          ...
          if (e is FlutterBluePlusException && e.code == FbpErrorCode.timeout.index) {
            ...
            await FlutterBluePlus._invokeMethod(() => FlutterBluePlusPlatform.instance.disconnect(BmDisconnectRequest(remoteId: remoteId))); // cancel connection attempt
          }
          throw e;
        });
  ...
  Future<void> disconnect({
    ...
    try {
      ...
      // invoke
      bool changed = FlutterBluePlus._connectionStates[remoteId]?.connectionState == BmConnectionStateEnum.connected;
      await FlutterBluePlus._invokeMethod(() => FlutterBluePlusPlatform.instance.disconnect(BmDisconnectRequest(remoteId: remoteId)));
  ...
  Future<List<BluetoothService>> discoverServices({bool subscribeToServicesChanged = true, int timeout = 15}) async {
    ...
    try {
      ...
      // invoke
      await FlutterBluePlus._invokeMethod(() => FlutterBluePlusPlatform.instance.discoverServices(BmDiscoverServicesRequest(remoteId: remoteId)));
  ...
  Future<int> readRssi({int timeout = 15}) async {
    ...
    try {
      ...
      // invoke
      await FlutterBluePlus._invokeMethod(() => FlutterBluePlusPlatform.instance.readRssi(BmReadRssiRequest(remoteId: remoteId)));
  ...
  Future<int> requestMtu(int desiredMtu, {double predelay = 0.35, int timeout = 15}) async {
    ...
    try {
      ...
      // invoke
      await FlutterBluePlus._invokeMethod(() => FlutterBluePlusPlatform.instance.requestMtu(request));
  ...
  Future<void> requestConnectionPriority({required ConnectionPriority connectionPriorityRequest}) async {
    ...
    // invoke
    await FlutterBluePlus._invokeMethod(() => FlutterBluePlusPlatform.instance.requestConnectionPriority(request));
  }
  ...
  Future<void> setPreferredPhy({
    ...
    // invoke
    await FlutterBluePlus._invokeMethod(() => FlutterBluePlusPlatform.instance.setPreferredPhy(request));
  }
  ...
  Future<void> createBond({int timeout = 90}) async {
    ...
    try {
      ...
      // invoke
      bool changed = FlutterBluePlus._bondStates[remoteId]?.bondState != BmBondStateEnum.bonded;
      await FlutterBluePlus._invokeMethod(() => FlutterBluePlusPlatform.instance.createBond(BmCreateBondRequest(remoteId: remoteId)));
  ...
  Future<void> removeBond({int timeout = 30}) async {
    ...
    try {
      ...
      // invoke
      bool changed = FlutterBluePlus._bondStates[remoteId]?.bondState == BmBondStateEnum.bonded;
      await FlutterBluePlus._invokeMethod(() => FlutterBluePlusPlatform.instance.removeBond(BmRemoveBondRequest(remoteId: remoteId)));
  ...
  Future<void> clearGattCache() async {
    ...
    // invoke
    await FlutterBluePlus._invokeMethod(() => FlutterBluePlusPlatform.instance.clearGattCache(BmClearGattCacheRequest(remoteId: remoteId)));
  }
  ...
  Stream<BluetoothBondState> get bondState async* {
    ...
    if (FlutterBluePlus._bondStates[remoteId] == null) {
      var val = await FlutterBluePlus._invokeMethod(() => FlutterBluePlusPlatform.instance.getBondState(BmBondStateRequest(remoteId: remoteId)));
