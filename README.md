...
// cleanup: cancel subscription when device is disconnected
// note: `delayed:true` lets your listener receive the `disconnected` event.
await device.cancelWhenDisconnected(delayed: true);
