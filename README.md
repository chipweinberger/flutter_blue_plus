...
| events.onGapNameChanged         🌀 | :white_check_mark: | :white_check_mark: |        | Stream of gap name changes of *all devices*           |
...
| onGapNameChanged       🌀 | :white_check_mark: | :white_check_mark: |        | The GAP Device Name Characteristic (0x2A00) changed        |
