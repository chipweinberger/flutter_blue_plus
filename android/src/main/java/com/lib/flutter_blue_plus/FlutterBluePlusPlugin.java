...
//                        if (((boolean) data.get("nearest_device")) != false) {
//                            // the polling refresh is done only if I no longer receive samples from the nearest device
//                            Timer timer = new Timer();
//                            timer.scheduleAtFixedRate(new TimerTask() {
//                                @Override
//                                public void run() {
//                                    if (nearestDeviceResolver.getNearestDevice() != null && !nearestDeviceResolver.getNearestDevice().isAlive())
//                                        nearestDeviceResolver.refreshNearestDevice(LocalDateTime.now());
//                                }
//                            }, 0, NEAREST_REFRESH_TIMEOUT);
//                        }
