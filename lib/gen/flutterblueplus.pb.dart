...
class ConnectionPriorityRequest extends $pb.GeneratedMessage {
  ...
  factory ConnectionPriorityRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ConnectionPriorityRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ConnectionPriorityRequest clone() =>
      ConnectionPriorityRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ConnectionPriorityRequest copyWith(
          void Function(ConnectionPriorityRequest) updates) =>
      super.copyWith((message) => updates(message as ConnectionPriorityRequest))
          as ConnectionPriorityRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ConnectionPriorityRequest create() => ConnectionPriorityRequest._();
  ConnectionPriorityRequest createEmptyInstance() => create();
  static $pb.PbList<ConnectionPriorityRequest> createRepeated() =>
      $pb.PbList<ConnectionPriorityRequest>();
  @$core.pragma('dart2js:noInline')
  static ConnectionPriorityRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ConnectionPriorityRequest>(create);
  ...
  @$pb.TagNumber(2)
  $core.int get connectionPriority => $_getIZ(1);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $core.bool hasConnectionPriority() => $_has(1);
  @$pb.TagNumber(2)
...
class PreferredPhy extends $pb.GeneratedMessage {
  ...
  factory PreferredPhy.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PreferredPhy.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PreferredPhy copyWith(void Function(PreferredPhy) updates) =>
      super.copyWith((message) => updates(message as PreferredPhy))
          as PreferredPhy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PreferredPhy create() => PreferredPhy._();
  PreferredPhy createEmptyInstance() => create();
  static $pb.PbList<PreferredPhy> createRepeated() =>
      $pb.PbList<PreferredPhy>();
  @$core.pragma('dart2js:noInline')
  static PreferredPhy getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PreferredPhy>(create);
