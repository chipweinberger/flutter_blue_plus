...
const AdvertisementData$json = const {
  ...
  '2': const [
    ...
    const {'1': 'appearance', '3': 7, '4': 1, '5': 11, '6': '.Int32Value', '10': 'appearance'},
  ],
...
final $typed_data.Uint8List advertisementDataDescriptor = $convert.base64Decode('');
