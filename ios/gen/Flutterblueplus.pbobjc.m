...
@implementation ProtosFlutterblueplusRoot
...
#pragma mark - ProtosFlutterblueplusRoot_FileDescriptor

static GPBFileDescriptor *ProtosFlutterblueplusRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        ...
        .dataTypeSpecific.clazz = Nil,
        .number = ProtosConnectionPriorityRequest_FieldNumber_ConnectionPriority,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(ProtosConnectionPriorityRequest__storage_, connectionPriority),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldTextFormatNameCustom | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeInt32,
      },
    };
